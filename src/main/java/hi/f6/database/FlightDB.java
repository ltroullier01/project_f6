...
public class FlightDB {
    ...
    public List<Flight> searchWithoutDepartureCity(String arrivalCity, LocalDate departureDate,
            LocalDate arrivalDate) {
        List<Flight> listeFlight = new ArrayList<>();
        ...
        try (PreparedStatement pstmt = this.con.prepareStatement(select)) {
            ...
            pstmt.setString(2, departureDate.toString());
            pstmt.setString(3, arrivalDate.toString());
    ...
    public List<Flight> searchWithoutDepartureAndArrivalCity(LocalDate departureDate, LocalDate arrivalDate) {
        ...
        try (PreparedStatement pstmt = this.con.prepareStatement(select)) {
            ...
            pstmt.setString(1, departureDate.toString());
            pstmt.setString(2, arrivalDate.toString());
